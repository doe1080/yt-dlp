...
class TVerIE(TVerBaseIE):
    ...
    _TESTS = [{
        'url': 'https://tver.jp/episodes/eph98jh6nw',
        'info_dict': {
            'id': 'eph98jh6nw',
            'ext': 'mp4',
            'title': '「水曜日のダウンタウン」の説から生まれた、史上初の‘帯’バラエティ',
            'alt_title': '2021年放送',
            'channel': 'TBS',
            'channel_id': 'tbs',
            'description': 'md5:cd695b7c56365b986ca12c18f188576e',
            'display_id': '0b918431abad484093b7875d3fcd2b68',
            'duration': 2719.917,
            'episode': '「水曜日のダウンタウン」の説から生まれた、史上初の‘帯’バラエティ',
            'episode_id': 'eph98jh6nw',
            'episode_number': 1,
            'live_status': 'not_live',
            'modified_date': '20250507',
            'modified_timestamp': 1746597006,
            'release_date': '20250507',
            'release_timestamp': 1746626220,
            'season_id': 's0500501',
            'series': 'すてきに帯らいふ',
            ...
            'thumbnails': list,
            'timestamp': 1746586295,
            'upload_date': '20250507',
            'uploader_id': 'tver-tbs',
            '_old_archive_ids': ['brightcovenew 0b918431abad484093b7875d3fcd2b68'],
        },
    }, {
    ...
    def _real_extract(self, url):
        ...
        return {
            **self._extract_from_streaks_api(ep_info[top_key]['projectID'], media_id),
            **common_info,
    ...
    def _real_extract(self, url):
        ...
        return {
            **self._extract_from_streaks_api(
                project_id, media_id, ssai=content['title'] not in self.LIVE_24H),
