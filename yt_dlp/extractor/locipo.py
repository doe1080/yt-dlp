...
class LocipoIE(LocipoBaseIE):
    ...
    _TESTS = [{
        ...
        'url': 'https://locipo.jp/creative/210db9b9-b3f5-4dc6-9045-1457315de3b8?list=84cf44f1-23e3-44f9-a72a-1776778a8cec',
        'info_dict': {
            'id': '210db9b9-b3f5-4dc6-9045-1457315de3b8',
            'ext': 'mp4',
            'title': '【LBS】「透明醤油」世界の調味料に',
            'description': 'md5:2b1091547227d378265519a763bf9265',
            'duration': 260,
            'genres': ['ドキュメンタリー・時事・教養'],
            'modified_date': '20241010',
            'modified_timestamp': 1728557271,
            'release_timestamp': 1728374400,
            'release_date': '20241008',
            'series': 'ローカルビジネスサテライト',
            'series_id': '84cf44f1-23e3-44f9-a72a-1776778a8cec',
            'thumbnail': r're:https?://.+\.(?:jpg|png)',
