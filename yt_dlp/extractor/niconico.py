...
class NiconicoLiveIE(NiconicoBaseIE):
    ...
    _TESTS = [{
        'url': 'https://live.nicovideo.jp/watch/lv347725263',
        'info_dict': {
            'id': 'lv347725263',
            'ext': 'mp4',
            'title': 'ありがとうございました',
            'categories': 'count:2',
            'channel': 'syunka',
            'channel_id': '126002165',
            'channel_url': 'http://www.nicovideo.jp/user/126002165',
            'comment_count': int,
            'description': 'md5:10d518ae24430cf5fd68680ef9b28b67',
            'live_status': 'was_live',
            'release_date': '20250509',
            'release_timestamp': 1746822822,
            'tags': 'count:2',
            'thumbnail': r're:https?://.+',
            'timestamp': 1746822822,
            'upload_date': '20250509',
            'uploader': 'syunka',
            'uploader_id': '126002165',
            'view_count': int,
            'webpage_url': 'https://live.nicovideo.jp/watch/lv347725263',
        },
        'skip': True,
    }, {
        ...
        'info_dict': {
            ...
            'uploader': '株式会社ドワンゴ',
            'view_count': int,
            'webpage_url': 'https://live.nicovideo.jp/watch/lv329299587',
        },
        'skip': True,
    }, {
        # user latest live
        'url': 'https://live.nicovideo.jp/watch/user/5599432',
        'info_dict': {
            'id': 'lv347589280',
            'ext': 'mp4',
            'title': str,
            ...
            'channel': 'おったん',
            'channel_id': '5599432',
            'channel_url': 'http://www.nicovideo.jp/user/5599432',
            'comment_count': int,
            'description': 'md5:00eaff31873b1942070444033d6b8137',
            'display_id': '5599432',
            'live_status': 'was_live',
            'release_date': '20250423',
            'release_timestamp': 1745417879,
            'tags': 'count:10',
            'thumbnail': r're:https?://.+',
            'timestamp': 1745417879,
            'upload_date': '20250423',
            'uploader': 'おったん',
            'uploader_id': '5599432',
            'view_count': int,
            'webpage_url': 'https://live.nicovideo.jp/watch/lv347589280',
        },
        'skip': True,
    }, {
        # channel latest live
        'url': 'https://live.nicovideo.jp/watch/ch2646441',
        'info_dict': {
            'id': 'lv347674449',
            'ext': 'mp4',
            'title': str,
            'categories': 'count:2',
            'channel': 'テレビ東京（ニコニコ実況）',
            'channel_id': 'ch2646441',
            'channel_url': 'https://ch.nicovideo.jp/channel/ch2646441',
            'comment_count': int,
            'description': 'md5:b742784d55ce611b80a1836036a27760',
            'display_id': 'ch2646441',
            'live_status': 'is_live',
            'release_date': '20250510',
            'release_timestamp': 1746903600,
            'tags': 'count:6',
            'thumbnail': r're:https?://.+',
            'timestamp': 1746903600,
            'upload_date': '20250510',
            'uploader': '株式会社ドワンゴ',
            'view_count': int,
            'webpage_url': 'https://live.nicovideo.jp/watch/lv347674449',
        },
        'skip': True,
    }]
